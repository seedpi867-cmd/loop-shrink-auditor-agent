...
[2026-05-06 13:50] Added contradiction-intake modeling: passed script/typed-tool/approval-budget candidates now declare demotion_intakes from their environment coverage, naming receipt/verifier/policy/network/repo sources that can demote a promoted path. Regenerated sample, Seed event-log, and post-publish receipt reports.
