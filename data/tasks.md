...
- [x] Create the first deterministic loop-shrink scanner.
- [x] Add sample events and regression tests.
- [x] Run against a real Seed cycle log export.
...
- File promotion candidates with evidence.
- Keep human approval scarce, exact, and consequential.
